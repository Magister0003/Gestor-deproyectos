...
if (!nombreProyectoMostrado) {
    const tituloProyecto = document.createElement('h1');
    tituloProyecto.textContent = "Archivos del Proyecto: " + archivo.nombre; // Concatenar el texto con el nombre del proyecto
    document.getElementById('tituloProyecto').appendChild(tituloProyecto);
    nombreProyectoMostrado = true;
        ...
        botonDescargarTodo.onclick = function() {
            window.location.href = 'descargarProyecto.php?idProyecto=' + idProyecto;
        };
